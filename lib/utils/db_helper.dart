import 'package:login/data/models/message.dart';
...
class DatabaseHelper {
  ...
  String taskTable = "message_table";
  String colId = "id";
  String colDate = "date";
  ...
  Future<Database> initializeDatabase() async {
    ...
    String path = directory.path + "ship.db";
...
//    var result = db.query(taskTable, orderBy: '$colStatus, $colDate, $colDate');
//    return result;
//  }

//  Future<List<Map<String, dynamic>>> getInCompleteTaskMapList() async {
//    Database db = await this.database;
//    var result = db.rawQuery('SELECT * FROM $taskTable where $colStatus = "" order by $colDate, $colDate ASC');
...
//    Database db = await this.database;
//    var result = db.rawQuery('SELECT * FROM $taskTable where $colStatus = "Task Completed" order by $colDate, $colDate ASC');
//    //var result = db.query(taskTable, orderBy: '$colStatus, $colDate, $colTime');
//    return result;
//  }
...
//  Future<int> insertTask(Message task) async {
//    Database db = await this.database;
...
//  Future<int> updateTask(Message task) async {
...
//  Future<List<Message>> getTaskList() async{
//    var taskMapList = await getTaskMapList(); //Get Map List from database
//    int count = taskMapList.length;
//
//    List<Message> taskList = List<Message>();
//    //For loop to create Task List from a Map List
//    for (int i=0; i<count; i++){
//      taskList.add(Message.fromMapObject(taskMapList[i]));
//    }
//    return taskList;
//  }

//  Future<List<Message>> getInCompleteTaskList() async{
...
//  Future<List<Message>> getCompleteTaskList() async{
